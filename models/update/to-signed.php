...
$query_to_received = "UPDATE `document` SET `status` = 'signed', `dateUpdated` = '$timestamp', `isSent` = 1, `isReceived` = 1, `isEndorsed` = 1, `isReleased` = 1, `isReturned` = 1, `isSigned` = 1, `isApproved` = 0 WHERE `id` = '$document_id'";
...
$query_new_log = "INSERT INTO `log`(`id`, `documentID`, `date`, `status`, `updatedBy`) VALUES ('$new_log_id','$document_id','$timestamp','signed','$sender_id')";
